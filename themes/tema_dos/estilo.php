...
$files = file_scan_directory(getcwd() . "/themes/tema_dos/images/imagenes_banner", '.png');
...
.sp-content {
background: #7d7f72 url(/drupal/themes/tema_dos/images/grid.png) repeat scroll 0 0;
position: relative;
width: 100%;
height: 100%;
overflow: hidden;
...
.sp-parallax-bg {
background: url(/drupal/themes/tema_dos/images/map.png) repeat-x scroll 0 0;
...
cursor: pointer;
z-index: 1000;
background: transparent url(/drupal/themes/tema_dos/images/arrows.png) no-repeat;

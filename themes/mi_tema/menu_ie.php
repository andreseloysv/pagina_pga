<?php echo('
<link rel="stylesheet" href="http://www.compensa.com.ve/drupal/themes/mi_tema/menu_ie/css/style.css" type="text/css" media="screen, projection"/>
        ...
        <li><a href="#">Field Maintenance</a>
            <ul class="sub_menu">
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="#">Batters Box Templates</a></li>
